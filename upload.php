...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/FreeLand/Assets/images/profile_pics';
	//Set File name	
...
if (isset($_POST['x'])){
	...
	if($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG'){	
		...
		$insert_pic_query = $con->prepare("UPDATE users SET profile_pic=:profile_pic WHERE username=:userLoggedIn");
		$insert_pic_query->bindParam(":profile_pic", $result_path);
		$insert_pic_query->bindParam(":userLoggedIn", $userLoggedIn);
		$insert_pic_query->execute();

		//mysqli_query($con, "UPDATE users SET profile_pic='$result_path' WHERE username='$userLoggedIn'");
...
<div class="main_column column">
	...
	<div id="formExample">
	    ...
	    <form action="upload.php" method="post"  enctype="multipart/form-data">
	        ...
	        <input type="file" id="image" name="image" style="width:219px; height:30px; " /><br /><br />
